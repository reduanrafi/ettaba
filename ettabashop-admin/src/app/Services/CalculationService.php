...
class CalculationService
{
    ...
    public function CalculateGenerationBonusAmount($profit)
    {
        ...
        return floatval(number_format(($profit * $generationCommissionPercentage) / 100, 2));
    }
    ...
    public function CalculateGenerationBonusForIndividualUser($bonusAmount, $group, $type = 'point')
    {
        ...
        return floatval(number_format(($bonusAmount * $percentage) / 100, 2));

    }

    public function CalculateCompanyFunds($bonusAmount, $percentage)
    {
        return floatval(number_format(($bonusAmount * $percentage) / 100, 2));
    }
}