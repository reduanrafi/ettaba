            ...
            <div class="col-md-12">
                <div class="box box-info">
                    <div class="box-header with-border">
                        ...
                        <a href="{{ route('handcash.sale.index') }}" class="btn btn-block btn-primary btn-flat pull-right btn-sm"><i class="fa fa-plus"></i>Sale</a>
                        </div>
                               ...
                               @if(count($orders)>0)
                                   @foreach($orders as $order)
                                       <tr>
                                           ...
                                           <td>
                                               <a class="btn btn-sm btn-success">View detail</a>
                                           </td>
                                       </tr>
                                   @endforeach
                               @endif
