        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-info">
                    ...
                    <form class="form-horizontal" action="{{ route('handcash-product.store') }}" method="post"
...
{{--                                            </div>--}}
                                            ...
                                            <div class="col-md-4 col-sm-12 col-xs-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" min="0" class="form-control" id="direct_refer_commission"
                                                           name="direct_refer_commission" placeholder="Direct Refer Commission">
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 col-sm-12 col-xs-12">
                                                <div class="form-group">
                                                    <label for="tcb_en_readonly">Total Cash Back (TCB)</label>
                                            ...
                                            <div class="col-md-4 col-sm-12 col-xs-12">
                                                <div class="form-group">
                                                    <label for="trp_en_readonly">Total Rewards Points (TRP)</label>
