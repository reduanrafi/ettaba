            ...
            <div class="col-md-12">
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h3 class="box-title">Product edit form</h3>
                        <div class="pull-right box-tools">
                            <a href="{{ route('handcash-product.index') }} "
                    ...
                    @endif
                    <form class="form-horizontal" action="{{ route('handcash-product.update',['handcash_product'=>$product->id]) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        {!! method_field('PUT') !!}
                        <div class="box-body">
                            <div class="row">
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" min="0" class="form-control" id="productNameEn"
                                                           name="name_en" value="{{ $product->name }}" placeholder="Product Name">
                                                </div>
                                            </div>

                                            <div class="col-md-6 pull-right col-sm-12 col-xs-12">
                                                <div class="form-group">
                                                    <label for="productNameBn">Product short name</label>
                                                    <input type="text" min="0" class="form-control" id="productNameBn"
                                                           name="name_bn" value="{{ $product->short_name }}" placeholder="Product Name">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
...
{{--                                        </div>--}}
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-2 col-sm-12 col-xs-12">
                                                    <div class="form-group">
                                                        <label for="direct_refer_commission">Direct Refer</label>
                                                        <input type="text" min="0" class="form-control" id="direct_refer_commission"
                                                               name="direct_refer_commission"
                                                               value="{{ $product->direct_refer_commission }}"
                                                               placeholder="Direct Refer">
                                                    </div>
                                                </div>
    ...
    <script>
        ...
        $(function () {
            ...
            function calculateTRP() {
                ...
                let trp = (erp - (rate + cb + directRefer)) / 20;
                if (trp < 0) trp = 0;
