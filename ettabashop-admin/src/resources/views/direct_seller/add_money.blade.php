...
<style>
    ...
    /* Calculation Row */
    .calculation-box {
        background: linear-gradient(135deg, #e6fcf5 0%, #d1f7ea 100%);
    ...
    .pay-now-btn {
        background: linear-gradient(135deg, #11998e 0%, #0d9488 100%);
        border: none;
        border-radius: 8px;
        color: #ffffff;
        padding: 12px 35px;
...
<div class="add-money-container">
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="premium-card">
                <div class="premium-card-header">
                    <span>Add Money (Direct Selling)</span>
                    <span class="label label-primary" style="font-size: 14px; padding: 6px 12px; border-radius: 4px; background-color: #0d9488 !important;">
                        Current E-Balance: ৳ {{ number_format($user->direct_selling_balance, 2) }}
                    </span>
                </div>
                <div class="premium-card-body">
                    ...
                    <form id="addMoneyForm" method="POST" action="{{ route('direct-seller.add_money.initiate') }}">
                        @csrf
                        ...
                        <div class="section-title">
                            ...
                            <div class="help-icon-wrapper">
                                ...
                                <div class="custom-tooltip">
                                    আপনি যে Payment Gateway নির্বাচন করবেন, পেমেন্ট সম্পন্ন করতে অবশ্যই সেই Gateway ব্যবহার করুন। অন্য Gateway ব্যবহার করলে পেমেন্ট রিফান্ড পেতে সমস্যা হতে পারে।
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="calculation-box">
                            <div class="calc-item">
                                <div class="calc-label">Add Amount</div>
                            ...
                            <div class="calc-operator">=</div>
                            <div class="calc-item">
                                <div class="calc-label">Total Payment</div>
                                <div class="calc-value-container">
        ...
        <div class="col-md-12">
            <div class="premium-card">
                <div class="premium-card-header" style="background: linear-gradient(135deg, #1e3c72 0%, #2a5298 100%);">
