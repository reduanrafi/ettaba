...
<head>
    ...
    <title>Ettaba Shop | Simulated Payment Gateway (Direct Selling)</title>
...
<body>
    <div class="gateway-wrapper">
        <div class="gateway-header">
            ...
            <div class="logo-subtext">Unified Payment Aggregator (Direct Selling)</div>
        </div>
        <div class="gateway-body">
            <div class="payment-summary">
                <div class="summary-row">
                    <span class="summary-label">Seller Name</span>
            ...
            <form method="POST" action="{{ route('direct-seller.add_money.gateway.process', ['transaction_id' => $history->transaction_id]) }}">
                @csrf
