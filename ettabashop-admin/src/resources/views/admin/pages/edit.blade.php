                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" value="{{ $page->title }}" class="form-control" id="page-name" name="title" placeholder="Page Name">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-8">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" value="{{ $page->sub_title }}" class="form-control" id="page-name" name="sub_title" placeholder="Page Name">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-8">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea name="description" class="form-control" rows="20"  >{{ $page->description }}</textarea>
                                        </div>
                                    </div>
                                </div>
