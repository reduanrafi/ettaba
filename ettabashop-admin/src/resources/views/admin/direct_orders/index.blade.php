            ...
            <div class="col-md-12">
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h3 class="box-title">Direct Orders</h3>
                ...
                <!-- /.box-header -->
                    ...
                    <div class="box-body">
                        ...
                        <div class="col-md-6">
                            <a href="{{ route('dOrder.index',['state'=>'new']) }}" class="btn btn-sm btn-success">New
                                Orders</a>
                            <a href="{{ route('dOrder.index',['state'=>'']) }}" class="btn btn-sm btn-success">Orders
                                today</a>
                            <a href="{{ route('dOrder.index',['state'=>'all']) }}" class="btn btn-sm btn-success">All
                                Orders</a>
                        </div>
                    </div>
                    <!-- /.box-body -->
                    <div class="box-footer">
                        <table id="orderTable" class="table table-bordered table-hover">
                            ...
                            <tbody>
                            @if($direct_orders)
                                  @foreach($direct_orders as $order)
                                    <tr>
                                        <td>{{ $order->id }}</td>
                                        ...
                                        <td>
                                            ...
                                            <br>
                                            <span style="font-size: 12px; font-style: italic">{{ date('h:i a',strtotime($order->created_at)) }}</span>

                                        </td>
                                        <td>
                                            <span style="font-size: 16px; font-style: normal">Name : {{ $order->username }}</span><br>
                                            <span style="font-size: 12px; font-style: normal">Phone :{{ $order->phone }}</span><br>
                                            <span style="font-size: 10px; font-style: normal">Address :{{ $order->address }}</span><br>

                                        </td>
                                        <td class="text-center">
                                            <a href="{{  route('dOrder.detail',['id'=>$order->id]) }}"
