            ...
            <div class="col-md-12">
                ...
                <!-- /.box-header -->
                    ...
                    <div class="box-body">
                        ...
                        <div class="col-md-6">
                            <a href="{{ route('order.index',['state'=>'new']) }}" class="btn btn-sm btn-success">New
                                Orders</a>
                            <a href="{{ route('order.index',['state'=>'']) }}" class="btn btn-sm btn-success">Orders
                                today</a>
                            <a href="{{ route('order.index',['state'=>'all']) }}" class="btn btn-sm btn-success">All
                                Orders</a>
                        </div>
                    </div>
                    <!-- /.box-body -->
