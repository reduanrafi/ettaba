...
<div class="container-fluid pt-5">
    <div class="text-center mb-4">
        <h2 class="section-title px-5"><span class="px-2">{{ __("titles.mostRated") }}</span></h2>
    </div>
    <div class="row px-xl-5 pb-3">
        @if($topRated!=0)
            @foreach($topRated->products as $k=>$product)
                <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                    <div class="card product-item border-0 mb-4">
                        <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                            {{--                    <img class="img-fluid w-100" src="{{ asset($product->featured_image)}}" alt="">--}}
                        ...
                        <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                            ...
                            <div class="d-flex justify-content-center">
                                <h6>{{ $local=='bn'?$product->price_bn:$product->price_en}}</h6>
                                <h6 class="text-muted ml-2">
                                    <del>{{ $local=='bn'?$product->price_bn:$product->price_en}}</del>
                                </h6>
