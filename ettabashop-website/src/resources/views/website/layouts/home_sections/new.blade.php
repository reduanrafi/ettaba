...
<section class="container-fluid pt-2 px-xl-5">
    <div class="d-flex justify-content-between align-items-end mb-4 pr-xl-5 pl-xl-2">
        <div>
            <h6 class="text-primary font-weight-bold text-uppercase mb-1" style="letter-spacing: 2px;">Fresh Stock</h6>
            <h2 class="font-weight-extra-bold m-0" style="font-weight: 800; color: #1e293b;">{{ __("titles.new") }}</h2>
        </div>
        <a href="{{ route('allProducts', ["type" => "new"]) }}"
