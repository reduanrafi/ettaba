                    ...
                    <div class="col-lg-6">
                        <div class="cmp-info">
                            <div class="cm-logo">
                                ...
                                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Soluta fugit nobis dolorum
                                    dignissimos, optio commodi et quisquam? Odit, libero ullam nisi explicabo </p>
                            </div>
                                            ...
                                            <div class="col-lg-12 no-pdd">
                                                <div class="sn-field">
                                                    <input type="text" name="phone"
                                                        placeholder="{{ __('forms.phonePlaceholder') }}">
                                                    <i>
